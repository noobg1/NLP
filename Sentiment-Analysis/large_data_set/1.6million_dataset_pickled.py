...
open_file= open("pos_neg_large_dataset_linearSVM_corpus_transform_after_lemmatization.pickle", "rb")
...
if __name__ == "__main__":
        ...
        # with open('pos_neg_large_dataset_linearSVM.pickle', 'wb') as fid:
        #     pickle.dump(trained, fid)
        t1 = time.clock()
        open_file = open("pos_neg_large_dataset_linearSVM_after_lemmatization.pickle", "rb")
        trained = pickle.load(open_file)
        open_file.close()
        print (time.clock() - t1)
        ...
        #   print (_)
        X_test = vectorizer.transform(process_test_sentences(test_sen_all))

        # print(accuracy_score(y_test, knnr))
        # print(classification_report(y_test, knnr))
        print(trained.decision_function(X_test))
        distance = (trained.decision_function(X_test))
